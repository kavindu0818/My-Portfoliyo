        ...
        <div className="w-full">
          ...
          <div className="flex flex-col gap-12 relative w-full sm:w-auto">
            ...
            <ResumeCard
                ...
                subTitle="University of Bolton (2025-2026)"
                result=""
                des="The BSc (Hons) Computer Science at the University of Bolton (2025-2026) covers software development, AI, cybersecurity, and cloud computing. It emphasizes hands-on learning, problem-solving, and industry-relevant skills, preparing graduates for careers in tech."
            />
            <ResumeCard
